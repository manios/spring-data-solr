...
import org.springframework.data.solr.server.support.CloudSolrClientFactoryBean;
import org.w3c.dom.Element;

/**
 * Implementation of {@link BeanDefinitionParser} that parses {@code cloud-solr-client} element.
 * 
...
public class CloudSolrClientBeanDefinitionParser extends AbstractBeanDefinitionParser {
	...
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
		BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CloudSolrClientFactoryBean.class);
		setSolrClient(element, builder);
		return getSourcedBeanDefinition(builder, element, parserContext);
	}

	private void setSolrClient(Element element, BeanDefinitionBuilder builder) {
